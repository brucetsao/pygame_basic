...
pygame.draw.line(bg,(0,0,255),(0,0),(screen.get_width(),screen.get_height()),3)
#(0,0)為左上角座標,(screen.get_width(),screen.get_height())為右下角座標
pygame.draw.line(bg,(0,0,255),(0,screen.get_height()),(screen.get_width(),0),3)
