...
pygame.display.set_caption("PyGame Sprite 功能介紹:產生一個球與一隻蝴蝶，全方位移動中碰撞會互彈開")
...
# 創建第一個玩家精靈
player = Player('./images/ball.png','Ball' , random.randint(50,screen.get_width()), random.randint(50,screen.get_height()),screen)
player.move = random.randint(3,10)
#透過亂數函數random.randint(a,b)，設定產生物件之移動距離為a~b之間，亦為3~10

# 創建第二個玩家精靈
player1 = Player('./images/butterfly.png','Butterfly' , random.randint(50,screen.get_width()), random.randint(50,screen.get_height()),screen)
...
while running:
    ...
    #檢查碰撞
    if pygame.sprite.collide_rect(player,player1):  #檢查第一個腳色player與第二個腳色player1是否碰撞
        player.bounce()     #第一個腳色反向
        player1.bounce()     #第二個腳色反向
