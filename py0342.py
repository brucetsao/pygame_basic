...
pygame.display.set_caption("PyGame繪圖功能介紹:畫出一個2π，分成10等份，每次畫20等份的弧度連續縮小的五個大小弧形框")
...
for c in range(0,5):
    for m in range(0,10):
        pygame.draw.arc(bg, (0, 0, 255), [1+c* (w/10), 1+ c* (h/10), w * ((5-c)/5) - 2, h* ((5-c)/5) - 2], m* arc1 , m* arc1 +arc2, 1)
